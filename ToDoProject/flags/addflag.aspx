<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addflag.aspx.cs" Inherits="ToDoProject.flags.addflag" %>
                    ...
                    <div class="col-lg-12">
                        <form id="form1" runat="server">
                            ...
                            <div class="form-group">
                                <label for="flagAdd">Flag Text</label>
                                <asp:TextBox runat="server" ID="flagAdd" CssClass="form-control" placeholder="Type Text" />
                            </div>
