<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adddaily.aspx.cs" Inherits="ToDoProject.daily.adddaily" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form id="form1" runat="server">
                            ...
                            <div class="form-group">
                                <label for="dailyAdd">Daily Task Text</label>
                                <asp:TextBox runat="server" ID="dailyAdd" CssClass="form-control" placeholder="Type Daily Task" />
                            </div>
                            <asp:Button Text="Save" ID="saveButton" runat="server" CssClass="btn btn-success" OnClick="saveButton_Click" />
                            <a href="/daily/listdaily.aspx" class="btn btn-primary">List</a>
                        </form>
                    </div>
                </div>
            </div>
