<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listdaily.aspx.cs" Inherits="ToDoProject.daily.listdaily" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form id="form1" runat="server">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <asp:Repeater ID="repeaterId" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td><%#Eval("tododaily_id") %> </td>
                                                <td><%#Eval("tododaily_text") %> </td>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:HyperLink NavigateUrl='<%# "deletedaily.aspx?id=" + Eval("tododaily_id") %>' runat="server" CssClass="btn btn-danger"> Delete </asp:HyperLink>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                            ...
                            <a href="/daily/adddaily.aspx" class="btn btn-primary">Back</a>
                        </form>
                    </div>
                </div>
            </div>
