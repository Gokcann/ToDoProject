<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listweekly.aspx.cs" Inherits="ToDoProject.weekly.listweekly" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form id="form1" runat="server">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <asp:Repeater ID="repeaterId" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td><%#Eval("todoweekly_id") %> </td>
                                                <td><%#Eval("todoweekly_text") %> </td>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:HyperLink NavigateUrl='<%# "deleteweekly.aspx?id=" + Eval("todoweekly_id") %>' runat="server" CssClass="btn btn-danger"> Delete </asp:HyperLink>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                            ...
                            <a href="/weekly/addweekly.aspx" class="btn btn-primary">Back</a>
                        </form>
                    </div>
                </div>
            </div>
